  ...
  return (
    <a
      ...
      className={[
        ...
        "border border-white/15 px-6 py-3 text-white sm:px-8 sm:py-3.5",
    ...
    >
      ...
      />
      <span className="relative text-base font-semibold tracking-tight sm:text-lg">
        {children}
      </span>
      <svg
        viewBox="0 0 24 24"
        ...
        aria-hidden
        className="relative h-4 w-4 transition-transform duration-500 group-hover:translate-x-1 sm:h-5 sm:w-5"
      >
        <path d="M5 12h14" />
